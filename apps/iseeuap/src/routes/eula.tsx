...
export const Route = createFileRoute("/eula")({
  component: () => (
    <article className="leading-relaxed text-gray-900">
      <header className="bg-zinc-800 p-6 text-white">
        <h1 className="text-3xl font-bold">
          Contrato de Licencia para Usuarios Finales (EULA)
        </h1>
      </header>
      <main className="container mx-auto bg-white p-6 shadow-md">
        ...
        <section className="mb-8">
          ...
          <h4 className="mb-2 text-lg font-semibold">Tipos de Licencias</h4>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h4 className="mb-2 text-lg font-semibold">Cambios</h4>
          <p className="mb-4">
          ...
          <h4 className="mb-2 text-lg font-semibold">Mayoría de Edad</h4>
          <p className="mb-4">
          ...
          <h4 className="mb-2 text-lg font-semibold">Garantía</h4>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h4 className="mb-2 text-lg font-semibold">Indemnización</h4>
          <p className="mb-4">
        ...
        <section className="mb-6">
          <h2 className="mb-2 text-xl font-semibold">Cumplimiento de Leyes</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="mb-2 text-xl font-semibold">Contenido</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="mb-2 text-xl font-semibold">Actualizaciones</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="mb-2 text-xl font-semibold">Derecho de Usar Datos</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="mb-2 text-xl font-semibold">Opiniones</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="mb-2 text-xl font-semibold">Encabezados</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="mb-2 text-xl font-semibold">Compatibilidad</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="mb-2 text-xl font-semibold">Software de Evaluación</h2>
          <p>
        ...
        <section className="mb-6">
          <h2 className="mb-2 text-xl font-semibold">Derechos de Licencia</h2>
          <p>
